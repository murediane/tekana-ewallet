...
async adminTopUpWallet(
  ...
  return this.walletsService.adminTopUpWallet(userId, amount, currency,request.user);
}
...
@UseGuards(JWTAuthGuard)
  ...
  async transferFunds(
    ...
    return this.walletsService.transferFunds(senderUserId, receiverEmail, amount, currency);
  }
  ...
  async findTransactionsByUserId(
    ...
    return this.walletsService.findTransactionsByUserId(new Types.ObjectId(userId));
  }
}